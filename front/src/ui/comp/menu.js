    ...
    return (
        <div>
            ...
            <nav className="main-menu">
                <ul className="login_">
                    <li><i className="fa fa-power-off fa-2x"></i><span className="nav-text">{props.login}</span></li>
                </ul>
                {(props.role === "user")
                    ?
                    <ul className="menu_">
                        ...
                        <li onClick={() => router("/pu2")} className="has-subnav"><a href="/pu2"><img src={cart_u}></img><i
                            className="fa fa-globe fa-2x"></i><span className="nav-text">Корзина</span></a></li>
                        <li onClick={() => router("/pu3")} className="has-subnav"><a href= "/pu3"><img src={orders_u}></img><i
                ...
                <ul className="logout">
                    <li onClick={() => router("/psi")} className="has-subnav"><a><img src={close}></img><i
